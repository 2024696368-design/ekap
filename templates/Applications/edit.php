 ...
 */
$this->assign('title', 'Edit Application');
?>

<div class="page-heading">
    <div>
        <span class="badge-soft status-<?= h($application->status ?: 'draft') ?> mb-2">
            <i class="bi bi-pencil-square me-1"></i>
            <?= h(ucwords(str_replace('_', ' ', $application->status ?: 'draft'))) ?>
        </span>
        <h1><?= __('Edit Programme Application') ?></h1>
        <p><?= h($application->program_title ?: 'Draft application') ?></p>
    </div>

    <div class="page-actions">
        <?= $this->Html->link(
            '<i class="bi bi-eye"></i>' . __('View Application'),
    ...
    <div class="form-section">
        <div class="form-section-heading">
            ...
            <div>
                ...
                <p><?= __('Update the programme information, schedule and target audience.') ?></p>
            </div>
        </div>
    ...
    <div class="form-section">
        <div class="form-section-heading">
            ...
            <div>
                ...
                <p><?= __('Update the programme purpose and expected benefits.') ?></p>
            </div>
        </div>
    ...
    <div class="form-section">
        <div class="form-section-heading">
            ...
            <div>
                ...
                <p><?= __('Update the programme budget and requested allocation.') ?></p>
            </div>
        </div>
    ...
    <div class="form-section">
        <div class="form-section-heading">
            ...
            <div>
                ...
                <p><?= __('Update safety considerations and the responsible contact person.') ?></p>
            </div>
        </div>
